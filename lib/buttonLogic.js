export const actions = {
  ...
  stepCurrentTaskBackOnce: 'stepCurrentTaskBackOnce',
  stepCurrentTaskForwardOnce: 'stepCurrentTaskForwardOnce',
...
export function priorTaskButton(workflowState) {
  ...
  const onClickAction = (() => {
    if (enabled) {
      return actions.stepCurrentTaskBackOnce;
    } else {
      return null;
    }
  })()
...
export function nextTaskButton(workflowState) {
  ...
  const onClickAction = (() => {
    if (isLatestTask) {
      ...
      return actions.stepCurrentTaskForwardOnce;
    }
  })()
  return { enabled, onClickAction }
}
